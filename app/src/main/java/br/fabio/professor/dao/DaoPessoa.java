...
public class DaoPessoa {
    ...
    public boolean update(Pessoa pessoa) {
        ...
        boolean result = banco.queryExecute("UPDATE pessoa SET " + "nome = ?, email = ?, senha = ? WHERE id = ?;", args);
    ...
    public ArrayList<Pessoa> getTodos() {
        ...
        if (ob != null) {
            for (int i = 0; i < ob.size(); i++) {
                ...
                pessoa.setSenha(ob.getString(i, "senha"));
    ...
    public Pessoa getPessoa(long id) {
        ...
        if (ob != null) {
            ...
            pessoa.setSenha(ob.getString(0, "senha"));
        }
